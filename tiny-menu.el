...
;; menus.
;;
;; To use the tiny menu, simply define the `tiny-menu-items'
;; variable and then map keys to the items using the
;; `tiny-menu-run-item' macro.
;;
;; `tiny-menu-items' is an alist of "items" where each "item" is a
...
;; menus by calling `tiny-menu' with no arguments, but the prompt
